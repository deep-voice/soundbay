...
'''
from soundbay.models import ResNetNChannel, GoogleResNet50withPCEN, ChristophCNN, ResNet182D, Squeezenet2D
...
models_dict = {'models.ResNetNChannel': ResNetNChannel,
